...
const language = {
    ...
    en: {
        ...
        wifi_credentials_updated_message: "The WiFi credentials were updated successfully! To make them take effect the WiFi has to be manually toggled off and on again or if the WiFi is already enabled the system could also restarted. Restart the system now? Keep in mind that restarting the system will reset all data that has been recorded so far.",
        ok:                               "OK",
    ...
    de: {
        ...
        wifi_credentials_updated_message: "Die WLAN Zugangsdaten wurden erfolgreich aktualisiert! Damit die Aktualisierung wirksam wird, muss das WLAN manuell aus- und wieder eingeschaltet werden. Falls das WLAN bereits aktiviert ist, kann das System auch neu gestartet werden. Soll das System jetzt neu gestartet werden? Beachten Sie, dass durch einen Neustart alle bisher aufgezeichneten Daten zurückgesetzt werden.",
        ok:                               "OK",
